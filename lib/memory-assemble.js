...
import { loadSharedMemory, filterMemoriesByUser, filterMemoriesForRead, searchMemories, effectiveStatementType, effectiveSupport, effectiveLifecycle, } from "./memory-store.js";
...
export function registerAssembleApi(web, adminToken) {
    web.register({
        ...
        handler: (req, res) => {
            ...
            // 防本机其他进程或 rebinding 页面自报 isMaster 套取主任记忆包
