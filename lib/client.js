...
function MemoryView(_props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-root", children: [
    ...
    showAdd && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-mem-overlay", onClick: () => setShowAdd(false), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modal", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modalHead", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "dsh-mem-modalTitle", children: "\u6DFB\u52A0\u8BB0\u5FC6" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "dsh-mem-modalClose", onClick: () => setShowAdd(false), title: "\u5173\u95ED\uFF08Esc\uFF09", children: "\xD7" })
      ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modalCount", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: addContent.trim() === "" ? "\u5185\u5BB9\u5FC5\u586B" : "Ctrl+Enter \u5FEB\u901F\u4FDD\u5B58" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
          addContent.length,
          " \u5B57"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modalRow", children: [
    ...
    editEntry !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-mem-overlay", onClick: () => setEditEntry(null), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modal", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modalHead", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "dsh-mem-modalTitle", children: "\u7F16\u8F91\u8BB0\u5FC6" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "dsh-mem-modalClose", onClick: () => setEditEntry(null), title: "\u5173\u95ED\uFF08Esc\uFF09", children: "\xD7" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modalMeta", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: formatLocal(editEntry.timestamp) }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\xB7" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
          editEntry.authorRole === "master" ? "\u4E3B\u4EBA" : editEntry.author,
          " \u5F55\u5165"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\xB7" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: editEntry.id })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "dsh-mem-modalLabel", children: "\u5185\u5BB9" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "textarea",
        {
          ...
          onKeyDown: (e) => {
            if (e.key === "Enter" && (e.ctrlKey || e.metaKey)) void handleEdit();
          }
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modalCount", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Ctrl+Enter \u5FEB\u901F\u4FDD\u5B58" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
          editContent.length,
          " \u5B57"
        ] })
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-modalRow", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "dsh-mem-modalLabel", children: "\u53C2\u4E0E\u8005 userid\uFF08\u9017\u53F7\u5206\u9694\uFF09" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { className: "dsh-mem-modalInput", value: editParticipants, onChange: (e) => setEditParticipants(e.target.value), placeholder: "userid1, userid2", style: { marginTop: 0 } })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-mem-btnRow", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "dsh-mem-btn", onClick: () => setEditEntry(null), children: "\u53D6\u6D88" }),
