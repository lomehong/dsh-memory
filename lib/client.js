...
function memoryIcon(size, active) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", "aria-hidden": true, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ellipse", { cx: "12", cy: "5.5", rx: "7", ry: "2.8", stroke: color, strokeWidth: "2" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M5 5.5v6c0 1.6 3.1 2.9 7 2.9s7-1.3 7-2.9v-6", stroke: color, strokeWidth: "2" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M5 11.5v6c0 1.6 3.1 2.9 7 2.9s7-1.3 7-2.9v-6", stroke: color, strokeWidth: "2" })
  ] });
}
